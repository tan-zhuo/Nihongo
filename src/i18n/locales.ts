export const zh = {
  ...
  home: {
    ...
    vocabTitle: '单词练习',
    vocabDesc: '2000 个常用词汇，支持「看意思打日语」和「看日语打意思」。',
    start: '开始练习',
  },
  levels: { all: '全部' },
  articles: {
...
export const ja: typeof zh = {
  ...
  home: {
    ...
    vocabTitle: '単語練習',
    vocabDesc: '常用単語2000語。「意味→日本語」「日本語→意味」の2モード。',
    start: '練習を始める',
  },
  levels: { all: 'すべて' },
  articles: {
...
export const en: typeof zh = {
  ...
  home: {
    ...
    vocabDesc: '2000 common words. Type Japanese from the meaning, or the meaning from Japanese.',
